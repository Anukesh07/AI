...
def checkResolution(clauses, query):
    ...
    if resolved:
        print('Knowledge Base entails the query as proved by the resolution')
    else:
        print("Knowledge Base doesn't entail the query since no empty set produced after the resolution")
